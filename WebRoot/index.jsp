...
<script language="javascript"> 
	function PrintTable(Id){ 
		var ele = document.getElementById(Id);
  		...
  		w.document.body.innerHTML = document.getElementById("printpage").contentWindow.document.body.innerHTML;
	...
	function GetContent(){
		document.getElementById("needprint").innerHTML="<iframe id=printpage src = 'zjs.jsp'  WIDTH=860 height=1300></iframe>";
	}
	function GetContent1(){
		document.getElementById("needprint").innerHTML="<iframe id=printpage src = 'ksd.html'  WIDTH=860 height=1300></iframe>";
	}
</script> 
...
<div class="container" >
  <div class="header" style="text-align:right;" >
  	<a href="#"><img src="" alt="Logo" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #C6D580; display:block;" /></a> 
  	 <input  type="button" onclick="return PrintTable(printpage)" value="打 印">
    <!-- end .header -->
    </div>
  <div class="sidebar1">
    <ul class="nav">
      <li><a href="#" onclick ="GetContent()">重金属（以铅计）原始记录</a></li>
      <li><a href="#">蒸发残渣原始记录</a></li>
      <li><a href="#">高锰酸钾消耗量原始记录</a></li>
      <li><a href="#">荧光物质、脱色试验原始记录</a></li>
      <li><a href="#">感官原始记录</a></li>
      <li><a href="#" onclick ="GetContent1()">食品包装物质扩散度计算</a></li>
    </ul>
...
--> 
    <!-- end .sidebar1 --></div>
<!--startprint-->
  <div id="needprint"  class="content">	</div>
<!--endprint-->
